...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -485057166;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        5 => wire_ApiClient_login_user_impl(port, ptr, rust_vec_len, data_len),
        2 => wire_ApiClient_new_impl(port, ptr, rust_vec_len, data_len),
        4 => wire_ApiClient_register_user_impl(port, ptr, rust_vec_len, data_len),
