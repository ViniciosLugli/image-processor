...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 2069223611;
...
abstract class RustLibApi extends BaseApi {
  Future<String> crateApiClientApiClientGetBaseUrl({required ApiClient that});

  Future<String?> crateApiClientApiClientGetCookies({required ApiClient that});

  Future<Response> crateApiClientApiClientLoginUser(
      {required ApiClient that,
      required String email,
      required String password});

  Future<ApiClient> crateApiClientApiClientNew({required String baseUrl});

  Future<Response> crateApiClientApiClientProcessImage(
      {required ApiClient that, required String imagePath});

  Future<Response> crateApiClientApiClientRegisterUser(
      {required ApiClient that,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<String> crateApiClientApiClientGetBaseUrl({required ApiClient that}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiClientApiClientGetBaseUrlConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiClientApiClientGetBaseUrlConstMeta =>
      const TaskConstMeta(
  ...
  Future<String?> crateApiClientApiClientGetCookies({required ApiClient that}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiClientApiClientGetCookiesConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiClientApiClientGetCookiesConstMeta =>
      const TaskConstMeta(
        debugName: "ApiClient_get_cookies",
        argNames: ["that"],
      );
  ...
  Future<Response> crateApiClientApiClientLoginUser(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiClientApiClientLoginUserConstMeta,
      argValues: [that, email, password],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiClientApiClientLoginUserConstMeta =>
      const TaskConstMeta(
  ...
  Future<ApiClient> crateApiClientApiClientNew({required String baseUrl}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiClientApiClientNewConstMeta,
      argValues: [baseUrl],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiClientApiClientNewConstMeta => const TaskConstMeta(
  ...
  Future<Response> crateApiClientApiClientProcessImage(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiClientApiClientProcessImageConstMeta,
      argValues: [that, imagePath],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiClientApiClientProcessImageConstMeta =>
      const TaskConstMeta(
        debugName: "ApiClient_process_image",
        argNames: ["that", "imagePath"],
      );
  ...
  Future<Response> crateApiClientApiClientRegisterUser(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiClientApiClientRegisterUserConstMeta,
      argValues: [that, name, email, password],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiClientApiClientRegisterUserConstMeta =>
      const TaskConstMeta(
  ...
  ApiClient
    ...
    return ApiClient.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  ApiClient
    ...
    return ApiClient.frbInternalSseDecode(
